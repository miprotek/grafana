...
<div class="modal-body">
	<div class="modal-header">
		<h2 class="modal-header-title">
			...
			<span class="p-l-1">Speichern als...</span>
		</h2>
	...
	<form name="ctrl.saveForm" class="modal-content" novalidate>
		<div class="p-t-2">
			<div class="gf-form">
				<label class="gf-form-label width-7">Neuer Name</label>
      ...
      <div class="gf-form">
		...
		<div class="gf-form-button-row text-center">
			<button type="submit" class="btn btn-success" ng-click="ctrl.save()" ng-disabled="!ctrl.isValidFolderSelection">Sichern</button>
			<a class="btn-text" ng-click="ctrl.dismiss();">Abbrechen</a>
		</div>
	</form>
</div>
`;
