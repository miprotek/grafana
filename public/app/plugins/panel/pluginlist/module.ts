...
class PluginListCtrl extends PanelCtrl {
  ...
  constructor($scope, $injector, private backendSrv) {
    ...
    this.pluginList = [];
    this.viewModel = [
      { header: 'Installierte Apps', list: [], type: 'app' },
      { header: 'Installierte Panels', list: [], type: 'panel' },
      { header: 'Installierte Datenquellen', list: [], type: 'datasource' },
    ];
  ...
  onInitEditMode() {
    ...
    this.addEditorTab('Optionen', 'public/app/plugins/panel/pluginlist/editor.html');
  }
